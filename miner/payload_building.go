...
type BuildPayloadArgs struct {
	...
	NoTxPool     bool                 // Manba addition: option to disable tx pool contents from being included
	Transactions []*types.Transaction // Manba addition: txs forced into the block via engine API
	GasLimit     *uint64              // Manba addition: override gas limit of the block to build
}
